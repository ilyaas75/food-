...
export const api = {
  ...
  checkout: async (body) => {
    const data = await request('/orders/checkout', { method: 'POST', body });
    return data.data?.order || data;
  },
  getOrders: () => request('/orders'),
  getOrder: (id) => request(`/orders/${id}`),
  createOrder: (body) => request('/orders/admin', { method: 'POST', body }),
  ...
  getMyPayments: () => request('/payments/my-history'),
  ...
  refundPayment: (id, body) => request(`/payments/${id}/refund`, { method: 'POST', body }),
  verifyPayment: (id, body) => request(`/payments/${id}/verify`, { method: 'POST', body }),
